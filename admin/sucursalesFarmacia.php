<?php
	...
	$usuario = "2";
        ...
        $farmacia = "4";
        $id = $_GET["id"];
        $farmacias = buscarFarmaciaEspecifica($id);
?>
<!--Author: W3layouts
...
<div class="inner-block">
    <div class="cols-grids panel-widget">
        <?php while($filas = mysqli_fetch_array($farmacias)){ ?>
        <h2>Listado de sucursales farmacia "<?php echo $filas['D_NOMBRE_FARMACIA']; ?>"</h2>
        <button onclick="location.href='nuevaSucursal.php?id=<?php echo $filas['C_ID_FARMACIA']; ?>'">Nueva Sucursal</button>
        <?php } ?>
			...
			<tr>
				...
				<td>
					...
					Opciones
                        ...
                        <?php $resultado = mostrarSucursalesFarmacia($id);
			while($filas = mysqli_fetch_array($resultado)){ ?>
				<tr>
				<td><a href="perfilSucursal.php?id=<?php echo $filas['C_ID_SUCURSAL'] ?>"><?php echo $filas['C_ID_SUCURSAL'] ?></a></td>
                                <td><a href="perfilSucursal.php?id=<?php echo $filas['C_ID_SUCURSAL'] ?>"><?php echo $filas['D_NOMBRE_SUCURSAL'] ?></a></td>
				<td><?php echo $filas['D_DIRECCION_SUCURSAL'] ?></td>
				<td><?php echo $filas['D_NOMBRE_COMUNA'] ?></td>
                                <td><?php echo $filas['D_NOMBRE_REGION'] ?></td>
				<td><?php echo $filas['N_TELEFONO_SUCURSAL'] ?></td>
                                <td>
                                    <?php if($filas['L_ACTIVA'] == TRUE){
                                        echo "Activa";
                                    }else{
                                        echo "Inactiva";
                                    } ?>
                                ...
                                <td><?php 
                                $fechaRegistro = obtenerFechaRegistroSucursal($filas['C_ID_SUCURSAL']);
                                while($auxFecha = mysqli_fetch_array($fechaRegistro)){
                                    echo $auxFecha["F_FECHA_REGISTRO"];
                                } ?></td>
                                <td>
                                    <a href="modificarSucursal.php?id=<?php echo $filas['C_ID_SUCURSAL']; ?>" > <img src="images/edit.png" title="Modificar"> </a>
                                    <a href="pagosSucursal.php?id=<?php echo $filas['C_ID_SUCURSAL']; ?>" > <img src="../images/ticket.png" title="Pagos realizados"> </a>
                                    </tr>
			<?php } ?>
		</table>
		</center>
