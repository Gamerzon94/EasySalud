...
<div class="inner-block">
    <div class="blank">
    	...
    	<div class="blankpage-main">
            <center> <?php while($filas = mysqli_fetch_array($especialidad)){ ?>
                <p>¿Esta seguro de eliminar la especialidad "<?php echo $filas['D_ESPECIALIDAD'];?>"?</p>
                <?php } ?>
                <br/>
                <button onclick="location.href='eliminarEspe.php?id=<?php echo $id; ?>'">Si</button> <button onclick="location.href='especialidades.php'">No</button>
                </center>
    	</div>
    </div>
</div>
