...
<div class="inner-block">
    <div class="blank">
    	...
    	<div class="blankpage-main">
    		<p>Vamos a aprovechar este ancho de banda para hacer una petición ajax y forzar el CDN para que ponga la página que buscas justo en... yyyyyy ya no está. Tu página ha desaparecido. ¡puf! No queda nada.</p>
    	</div>
    </div>
</div>
