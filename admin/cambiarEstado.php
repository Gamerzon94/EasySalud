<?php
	...
	$usuario = "2";
        ...
        if(isset($_GET["id"])){
            ...
            $auxEstados = cargarEstadosCuenta();
            if(isset($_POST["estado"])){
                $estado = $_POST["estado"];
            if($idUsuario == 1){
                ?><script>alert("No se permite cambiar el estado del administrador principal");
                window.location.href = "usuarios.php";</script><?php
            }else{
                actualizarEstadoUsuario($idUsuario,$estado);
                ?><script>alert("Estado cambiado");
                window.location.href = "usuarios.php";</script><?php
            }
            }
        }else{
...
<div class="inner-block">
    <div class="cols-grids panel-widget">
        ...
        <div class="chute chute-center text-center">
			...
			<?php while($row = mysqli_fetch_array($auxEstados)){?>
                        ...
                        <tr>
                            <td colspan="2">
                        <center><input type="submit" value="Cambiar Estado" id="cambiar" name="cambiar"></center>
                            </td>
                        </tr>
                </table> </form></center> <?php 
                } ?>
            </div>
        </div>
    </div>
