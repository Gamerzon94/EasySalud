<?php
	...
	$usuario = "2";
        ...
        if(isset($_POST['usuarios'])){
            if($_POST['usuarios']=='todas'){
                $resultado = mostrarUsuarios();
                $forma = TRUE;
                $opcion = 1;
            }else if($_POST['usuarios']=='pre'){
                $resultado = mostrarUsuariosPremium();
                $opcion = 2;
            }else if($_POST['usuarios']=='pen'){
                $resultado = mostrarUsuariosPendientesActivacion();
                $opcion = 3;
            }else if($_POST['usuarios']=='ac'){
                $resultado = mostrarUsuariosActivos();
                $opcion = 4;
            }else if($_POST['usuarios']=='sus'){
                $resultado = mostrarUsuariosSuspendidos();
                $opcion = 5;
            }else if($_POST['usuarios']=='el'){
                $resultado = mostrarUsuariosPendienteEliminacion();
                $opcion = 6;
            }else{
...
<div class="inner-block">
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var data = google.visualization.arrayToDataTable([
          ...
          ['Activas',     <?php echo $activas; ?>],
          ['Suspendidas',     <?php echo $suspendidas; ?>],
    ...
    <table border=\"1\">
			...
			<?php } ?>
                ...
                <?php if($opcion==1){
                    ?><a href="generar-pdf.php?usu=1">Descargar pdf</a><?php
                }else if($opcion==2){
                    ?><a href="generar-pdf.php?premium=1">Descargar pdf</a><?php
                }else if($opcion==3){
                    ?><a href="generar-pdf.php?pendiente=1">Descargar pdf</a><?php
                }else if($opcion==4){
                    ?><a href="generar-pdf.php?activos=1">Descargar pdf</a><?php
                }else if($opcion==5){
                    ?><a href="generar-pdf.php?suspendidos=1">Descargar pdf</a><?php
                }else if($opcion==6){
                    ?><a href="generar-pdf.php?elim=1">Descargar pdf</a><?php
                }?>
    	</div>
    </div>
</div>
