...
<div class="inner-block">
    <div class="blank">
    	...
    	<div class="blankpage-main">
            <form action="reporteGenerado3.php" method="post">
            <table>
                <tr>
                    <td >
                        Usuarios: &nbsp&nbsp</td><td>
                        <input type="radio" id="premium" name="premium" value="todas" /> Todos.</br>
                        <input type="radio" id="premium" name="premium" value="pre" /> Premium.</br>
                        <input type="radio" id="premium" name="premium" value="nor" /> Normales.</br>
                        <input type="radio" id="premium" name="premium" value="far" /> Todas las Farmacias.</br>
                        <input type="radio" id="premium" name="premium" value="farpre" /> Farmacias Activas.
                    </td>
                </tr>
                <tr>
                   <td>
