<?php
	...
	$usuario = "2";
        ...
        $farmacia = "4";
        $id = $_GET['id'];
        $sucursales = buscarSucursalEspecifica($id);
?>
<!--Author: W3layouts
...
<div class="inner-block">
    <div class="blank">
    	...
    	<div class="blankpage-main">
            <center> <?php while($filas = mysqli_fetch_array($sucursales)){ ?>
                <p>¿Esta seguro de eliminar la sucursal "<?php echo $filas['D_NOMBRE_SUCURSAL'];?>" de la farmacia "<?php echo $filas['D_NOMBRE_FARMACIA'];?>"?</p>
                <?php } ?>
                <br/>
                <button onclick="location.href='eliminarSucu.php?id=<?php echo $id; ?>'">Si</button> <button onclick="location.href='sucursales.php'">No</button>
                </center>
    	</div>
    </div>
</div>
