...
<div class="inner-block">
    <div class="blank">
    	...
    	<div class="blankpage-main">
            <form action="reporteGenerado4.php" method="post">
            <table>
                <tr>
                    <td >
                        Pagos: &nbsp&nbsp</td><td>
                        <input type="radio" id="pagos" name="pagos" value="todas" /> Todas.</br>
                        <input type="radio" id="pagos" name="pagos" value="usu" /> Profesionales de la salud.</br>
                        <input type="radio" id="pagos" name="pagos" value="far" /> Farmacias.
                    </td>
                </tr>
                <tr>
                   <td>
