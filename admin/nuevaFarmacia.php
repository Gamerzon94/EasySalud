...
<div class="inner-block">
    <div class="blank">
    	...
    	<div class="blankpage-main">
    		<form action="nuevaFarma.php" method="post" onsubmit="return validar();">
                    <table>
                        <tr>
                            <td>Nombre de la farmacia <br/>
                                <input type="text" name="nom" placeholder="Nombre de la Farmacia" required=""></td>
                            <td>Pagina Web de la farmacia <br/><input type="text" name="web" placeholder="Pagina Web Farmacia" required="""></td>
                            <td>Representante de la farmacia <br/><select name="rep" id="rep">
			...
			<?php while($representante = mysqli_fetch_array($auxRepresentante)){?>
                        ...
                        <tr><td><div class="forgot-top-grids">
                            <div class="clearfix"> </div>
                                ...
                                <input type="submit" name="nuevo" value="Crear farmacia"></td></tr>
                    </table>
		</form>
    	</div>
    </div>
