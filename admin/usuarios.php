...
<div class="inner-block">
    <div class="cols-grids panel-widget">
        ...
        <div class="chute chute-center text-center">
			...
			<option value="0" selected="true"  disabled="disabled">Seleccione estado</option>
			<?php $auxEstados = cargarEstadosCuenta();
                        while($row = mysqli_fetch_array($auxEstados)){?>
                            <option value="<?php echo $row['C_ID_ESTADO_CUENTA']; ?>"><?php echo $row['D_ESTADO_CUENTA']; ?></option>
                        <?php }?>
                                </select>
...
<center><table border=\"1\">
			<tr>
				...
				<td>
					Opciones
                        ...
                        <?php if(isset($_GET["idFiltro"])){
                            $idFiltro = $_GET["idFiltro"];
                            $resultado = mostrarUsuariosConFiltro($idFiltro);
                        }else{
			...
			while($filas = mysqli_fetch_array($resultado)){ 
                            $count++;?>
				<tr>
                                    <td><a href="perfilUsuario.php?id=<?php echo $filas['C_ID_USUARIO']?>"><?php echo $filas['S_RUN_USUARIO'] ?></a></td>
				<td><?php echo $filas['D_NOMBRE_USUARIO'] ?>&nbsp;<?php echo $filas['D_APELLIDO_USUARIO'] ?></td>
				<td><?php echo $filas['D_TIPO_USUARIO'] ?></td>
                                <td><?php echo $filas['D_ESTADO_CUENTA'] ?></td>
                                <td><a href="mailto:<?php echo $filas['D_EMAIL_USUARIO'] ?>"><?php echo $filas['D_EMAIL_USUARIO'] ?></a></td>
				<td><?php $auxRegistro = buscarRegistroUsuario($filas['C_ID_USUARIO']);
                                while($registro = mysqli_fetch_array($auxRegistro)){ 
                                    echo $registro['F_FECHA_REGISTRO'];
                                }
                                 ?></td>
                                <td> <a href="modificarUsuario.php?id=<?php echo $filas['C_ID_USUARIO']; ?>" > <img src="images/edit.png" title="Modificar"> </a>
                                    <a href="cambiarEstado.php?id=<?php echo $filas['C_ID_USUARIO']; ?>" > <img src="../images/flechas.png" title="Cambiar estado cuenta"> </a> </td>
                </tr>
			<?php } 
                        if($count == 0){ ?>
                <tr>
                    <td colspan="7">
                <center>Sin usuarios registrados.</center>
                    </td>
                </tr>
                        <?php }?>
		</table>
