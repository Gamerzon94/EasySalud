...
<div class="inner-block">
    <div class="blank">
    	<h2>Eliminar Farmacia</h2>
    	<div class="blankpage-main">
            <center> <?php while($filas = mysqli_fetch_array($farmacias)){ ?>
                <p>¿Esta seguro de eliminar la farmacia "<?php echo $filas['D_NOMBRE_FARMACIA'];?>"?</p><br/><p>Esta acción eliminara todas las sucursales asociadas a la farmacia</p>
                <?php } ?>
                <br/>
                <button onclick="location.href='eliminarFarma.php?id=<?php echo $id; ?>'">Si</button> <button onclick="location.href='farmacia.php'">No</button>
                </center>
    	</div>
    </div>
</div>
