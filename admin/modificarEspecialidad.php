<?php
	...
	$usuario = "2";
        ...
        $farmacia = "4";
        $id = $_GET["id"];
        $especialidad = buscarEspecialidadEspecifica($id);
?>
<!--Author: W3layouts
...
<div class="inner-block">
    <div class="blank">
        <?php while($filas = mysqli_fetch_array($especialidad)){ ?>
    	<h2>Modificar especialidad "<?php echo $filas['D_ESPECIALIDAD'];?>"</h2>
    	<div class="blankpage-main">
            <center><form action="modificarEspa.php" method="post" onsubmit="return validar();">
                    <table>
                        <tr>
                            <td>Nombre de la especialidad <br/>
                                <input type="hidden" id="id" name="id" value="<?php echo $filas['C_ID_ESPECIALIDAD'];?>">
                                <input type="text" name="nom" placeholder="Nombre de la especialidad" required="" value="<?php echo $filas['D_ESPECIALIDAD'];?>"</td>
                        </tr>
                        <tr><td><div class="forgot-top-grids">
                            <div class="clearfix"> </div>
			</div>
                                <input type="submit" name="nuevo" value="Modificar especialidad"></td></tr>
                    </table>
                </form></center>
    	</div>
        <?php } ?>
