...
<div class="inner-block">
    <div class="cols-grids panel-widget">
        ...
        <button onclick="location.href='nuevaEspecialidad.php'">Nueva Especialidad</button>
			...
			<tr>
				<td>
					...
					Opciones
                        ...
                        <?php
			while($filas = mysqli_fetch_array($especialidades)){ ?>
				<tr>
				<td><?php echo $filas['C_ID_ESPECIALIDAD'] ?> </td>
				<td><?php echo $filas['D_ESPECIALIDAD']?></td>
				<td><?php echo $filas['F_FECHA_REGISTRO']?></td>
                                 <td>
                                    <a href="modificarEspecialidad.php?id=<?php echo $filas['C_ID_ESPECIALIDAD']; ?>" > <img src="images/edit.png" title="Modificar"> </a>
                                    </tr>
			<?php } ?>
		</table>
		</center>
