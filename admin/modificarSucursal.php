<?php
	...
	$usuario = "2";
        ...
        $farmacia = "4";
        $idSucursal = $_GET["id"];
        $sucursal = buscarSucursalEspecifica($idSucursal);
        $comuna = cargarComuna();
?>
<!--Author: W3layouts
...
<div class="inner-block">
    <div class="blank">
    	...
    	<h2>Modificar sucursal "<?php echo $filas['D_NOMBRE_SUCURSAL'];?>" de la farmacia "<?php echo $filas['D_NOMBRE_FARMACIA'];?>"</h2>
    	<div class="blankpage-main">
    		<form action="modificarSucu.php" method="post" onsubmit="return validar();">
                    <table>
                        <tr>
                            <input type="hidden" id="id" name="id" value="<?php echo $idSucursal;?>">
                            
                            <td>Nombre de la sucursal <br/>
                                <input type="text" name="nom" placeholder="Nombre de la sucursal" required="" value="<?php echo $filas['D_NOMBRE_SUCURSAL'];?>"></td>
                            <td>Dirección de la sucursal <br/><input type="text" name="dir" placeholder="Dirección de la sucursal" required="" value="<?php echo $filas['D_DIRECCION_SUCURSAL'];?>"></td>
                            <td>Telefono de la sucursal <br/><input type="text" name="tel" placeholder="Telefono de la sucursal" required="" value="<?php echo $filas['N_TELEFONO_SUCURSAL'];?>"></td>
                            <td>Comuna <br/><select name="comuna" id="comuna">
			...
			<?php while($auxComuna = mysqli_fetch_array($comuna)){
                        ...
                        <tr><td><div class="forgot-top-grids">
                            <div class="clearfix"> </div>
                                ...
                                <input type="submit" name="nuevo" value="Modificar sucursal"></td></tr>
                    </table>
		</form>
            <?php } ?>
    	</div>
