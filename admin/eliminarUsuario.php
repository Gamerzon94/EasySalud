...
<div class="inner-block">
    <div class="blank">
    	...
    	<div class="blankpage-main">
            <center> <?php while($filas = mysqli_fetch_array($usuario)){ ?>
    		<p>¿Esta seguro de eliminar el usuario RUN: <?php echo $filas['S_RUN_USUARIO'];?> Nombre: <?php echo $filas['D_NOMBRE_USUARIO']." ".$filas['D_APELLIDO_USUARIO'];?>?</p>
                <?php } ?>
                <br/>
                <button onclick="location.href='eliminarUsu.php?id=<?php echo $id; ?>'">Si</button> <button href="usuarios.php" onclick="location.href='usuarios.php'">No</button>
                </center>
    	</div>
    </div>
</div>
