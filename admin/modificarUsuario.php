<?php
	...
	$usuario = "2";
        ...
        $comuna = cargarComuna();
        $usuario = buscarUsuarioEspecifico($id);
?>
<!--Author: W3layouts
...
<div class="inner-block">
    <div class="blank">
    	<h2>Modificar usuario RUN: <?php echo $filas['S_RUN_USUARIO'];?></h2>
    	<div class="blankpage-main">
    		<form action="modificarUsu.php" method="post" onsubmit="return validar();">
                    <table>
                        <tr>
                            <td>
                                <input type="hidden" id="id" name="id" value="<?php echo $filas['C_ID_USUARIO'];?>">
                                <input type="text" name="run" placeholder="RUN" required="" value="<?php echo $filas['S_RUN_USUARIO'];?>"></td>
                            <td><input type="text" name="nom" placeholder="Nombre" required="" value="<?php echo $filas['D_NOMBRE_USUARIO'];?>"></td>
                            <td><input type="text" name="ape" placeholder="Apellido" required="" value="<?php echo $filas['D_APELLIDO_USUARIO'];?>"></td>
                            <td><input type="text" name="email" placeholder="Email" required="" value="<?php echo $filas['D_EMAIL_USUARIO'];?>"></td>
                            <td><input type="text" name="email2" placeholder="Confirmar Email" required="" value="<?php echo $filas['D_EMAIL_USUARIO'];?>"></td></tr>
                        <tr><td><input type="text" name="tel" placeholder="Telefono" value="<?php echo $filas['N_TELEFONO_USUARIO'];?>"></td>
                            <td><input type="text" name="cel" placeholder="Telefono Movil" required="" value="<?php echo $filas['N_MOVIL_USUARIO'];?>"></td>
                            <td><input type="text" name="dir" placeholder="Dirección" required="" value="<?php echo $filas['D_DIRECCION_USUARIO'];?>"></td>
                            <td colspan="1"><input type="text" name="dep" placeholder="Departamento" value="<?php echo $filas['S_DEPTO_USARIO'];?>"></td></tr>
                        <tr><td>Fecha de nacimiento <input type="date" name="fechaNacimiento" placeholder="Fecha de nacimiento" required="" value="<?php echo $filas['F_FECHA_NACIMIENTO'];?>"></td>
                            <td><input type="password" name="cla" class="lock" placeholder="Contraseña" value="<?php echo $filas['D_CLAVE_USUARIO'];?>"></td>
                            <td><input type="password" name="cla2" class="lock" placeholder="Confirmar contraseña" value="<?php echo $filas['D_CLAVE_USUARIO'];?>"></td>
                    <td><select name="tipoUsuario" id="tipoUsuario">
			<option value="0">Seleccione tipo de usuario</option>
			<?php while($tip = mysqli_fetch_array($tipoUsuario)){
                            if($tip['C_ID_TIPO_USUARIO'] == $filas['C_ID_TIPO_USUARIO']){ ?>
                        <option value="<?php echo $tip['C_ID_TIPO_USUARIO']; ?>" selected="selected"><?php echo $tip['D_TIPO_USUARIO']; ?></option>
                            <?php }else{ ?>
			...
			<?php while($auxComuna = mysqli_fetch_array($comuna)){
                        ...
                        <tr><td><div class="forgot-top-grids">
                            <div class="clearfix"> </div>
                                ...
                                <input type="submit" name="modificar" value="Modificar usuario"></td></tr>
                    </table>
		</form>
    	</div>
    </div>
