<?php
	...
	$usuario = "2";
        ...
        $farmacia = "4";
        $idFarmacia = $_GET["id"];
        $farmacias = buscarFarmaciaEspecifica($idFarmacia);
        $comuna = cargarComuna();
?>
<!--Author: W3layouts
...
<div class="inner-block">
    <div class="blank">
    	...
    	<h2>Nueva sucursal de la farmacia "<?php echo $filas['D_NOMBRE_FARMACIA'];?>"</h2>
    	<div class="blankpage-main">
    		<form action="nuevaSucu.php" method="post" onsubmit="return validar();">
                    <table>
                        <tr>
                            <input type="hidden" id="id" name="id" value="<?php echo $filas['C_ID_FARMACIA'];?>">
                            <?php } ?>
                            <td>Nombre de la sucursal <br/>
                                <input type="text" name="nom" placeholder="Nombre de la sucursal" required=""></td>
                            <td>Dirección de la sucursal <br/><input type="text" name="dir" placeholder="Dirección de la sucursal" required=""></td>
                            <td>Telefono de la sucursal <br/><input type="text" name="tel" placeholder="Telefono de la sucursal" required=""></td>
			...
			<?php while($auxComuna = mysqli_fetch_array($comuna)){?>
                        ...
                        <tr><td><div class="forgot-top-grids">
                            <div class="clearfix"> </div>
                                ...
                                <input type="submit" name="nuevo" value="Crear sucursal"></td></tr>
                    </table>
		</form>
    	</div>
    </div>
