...
<div class="inner-block">
    <div class="blank">
    	...
    	<div class="blankpage-main">
            <form action="reporteGenerado2.php" method="post">
            <table>
                <tr>
                    <td >
                        Usuarios: &nbsp&nbsp</td><td>
                        <input type="radio" id="usaurios" name="usuarios" value="todas" /> Todas.</br>
                        <input type="radio" id="usaurios" name="usuarios" value="pre" /> Premium.</br>
                        <input type="radio" id="usaurios" name="usuarios" value="pen" /> Pendiente de activación.</br>
                        <input type="radio" id="usaurios" name="usuarios" value="ac" /> Activos.</br>
                        <input type="radio" id="usaurios" name="usuarios" value="sus" /> Suspendidos.</br>
                        <input type="radio" id="usaurios" name="usuarios" value="el" /> Pendiente de eliminación.
                    </td>
                </tr>
                <tr>
                   <td>
