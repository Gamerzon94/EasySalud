...
<div class="inner-block">
    <div class="blank">
    	...
    	<div class="blankpage-main">
            <form action="reporteGenerado.php" method="post">
            <table>
                <tr>
                    <td >
                        Atenciones: &nbsp&nbsp</td><td>
                        <input type="radio" id="atenciones" name="atenciones" value="todas" /> Todas.</br>
            <input type="radio" id="atenciones" name="atenciones" value="pen" /> Pendientes.</br>
            <input type="radio" id="atenciones" name="atenciones" value="rech" /> Rechazadas.</br>
            <input type="radio" id="atenciones" name="atenciones" value="fi" /> Finalizadas.</br>
            <input type="radio" id="atenciones" name="atenciones" value="can" /> Canceladas.</td>
                </tr>
                <tr>
                   <td>
