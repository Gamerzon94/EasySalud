...
<div class="inner-block">
    <div class="cols-grids panel-widget">
        ...
        <button onclick="location.href='nuevaFarmacia.php'">Nueva Farmacia</button>
        <div class="chute chute-center text-center">
			...
			<tr>
				...
				<tr>
				<td><?php echo $filas['C_ID_FARMACIA'] ?></td>
				<td><?php echo $filas['D_NOMBRE_FARMACIA'] ?></td>
				<td><?php echo $filas['D_WEB_FARMACIA'] ?></td>
                                <td><a href="perfilUsuario.php?id=<?php echo $filas["C_ID_USUARIO"] ?>"><?php echo $filas['D_NOMBRE_USUARIO']." ".$filas['D_APELLIDO_USUARIO'] ?></a></td>
				<td><?php echo $filas['F_FECHA_REGISTRO'] ?></td>
                                <?php $surcursales = contarSucursales($filas['C_ID_FARMACIA']);
                                $auxContador = 0;
                                while($filas2 = mysqli_fetch_array($surcursales)){ 
                                    echo "<td><center><a href=\"sucursalesFarmacia.php?id=".$filas['C_ID_FARMACIA']."\">".$filas2['sucursales']."</a></center></td>";
                                    $auxContador++;
                                }
                                if($auxContador==0){
                                    echo "<td><center>Farmacia sin sucursales</center></td>";
                                }
                                ?> <td> <a href="nuevaSucursal.php?id=<?php echo $filas['C_ID_FARMACIA']; ?>" > <img src="images/add.png" title="Nueva Sucursal"> </a>
                                    <a href="modificarFarmacia.php?id=<?php echo $filas['C_ID_FARMACIA']; ?>" > <img src="images/edit.png" title="Modificar"> </a>
                </tr>
			<?php } ?>
		</table>
		</center>
