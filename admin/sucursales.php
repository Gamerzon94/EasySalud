...
<div class="inner-block">
 ...
 <center><table border=\"1\">
			...
			<?php while($filas = $resultado->fetch_array(MYSQL_BOTH)){ ?>
				<tr>
				<td><?php echo $filas['C_ID_SUCURSAL'] ?></td>
				<td><?php echo $filas['D_NOMBRE_SUCURSAL'] ?></td>
				...
				<td><?php echo $filas['D_NOMBRE_FARMACIA'] ?></td>
                                ...
                                ?><td>
                                    ...
                                    <a href="eliminarSucursal.php?id=<?php echo $filas['C_ID_SUCURSAL']; ?>" > <img src="images/delete.png" title="Eliminar">  </a> </td>
                </tr>
			<?php } ?>
		</table>
		</center>
