<?php
	...
	$usuario = "2";
        ...
        if(isset($_GET['id'])){
            ...
            $auxProfesional = buscarProfesional($idProfesional);
        }else{
...
<div class="inner-block">
    <div class="blank">
    	...
    	<div class="blankpage-main">
            <?php while ($profesional = mysqli_fetch_array($auxProfesional)){
                echo "Nombre: ".$profesional["D_NOMBRE_USUARIO"]." ".$profesional["D_APELLIDO_USUARIO"]."<br/>";
                echo "Dirección: ".$profesional["D_DIRECCION_USUARIO"].", ".$profesional["D_NOMBRE_COMUNA"]."<br/>";
                if(($profesional["N_TELEFONO_USUARIO"]==0)&&($profesional["N_MOVIL_USUARIO"]==0)){
                    echo "Telefono: El usuario no tiene telefonos registrados."."<br/>";
                }else if($profesional["N_TELEFONO_USUARIO"]==0){
                    echo "Telefono: ".$profesional["N_MOVIL_USUARIO"]."<br/>";
                }else if($profesional["N_MOVIL_USUARIO"]==0){
                    echo "Telefono: ".$profesional["N_TELEFONO_USUARIO"]."<br/>";
                }else{
                    echo "Telefono: El usuario no tiene telefonos registrados."."<br/>";
                }
                echo "Email: ".$profesional["D_EMAIL_USUARIO"]."<br/>";
                if($profesional["L_PREMIUM"]==TRUE){
                    echo "Tipo: Usuario Premium.";
                }else{
                    echo "Tipo: Usuario normal.";
                }
                break;
            }?>
    	</div>
