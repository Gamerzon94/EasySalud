...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="content"> 
      <!-- ################################################################################################ -->
        <?php if(isset($_COOKIE["rol"])){ ?>
      <h1>Inscripcion premium </h1>
      Al ser miembro premium de Easy Salud aumenta sus posibilidades de ser solicitado dentro de su area ya que aparecera destacado dentro de las busquedas.
      <form action="compra.php" method="post">
          <input type="hidden" id="id" name="id" value="<?php echo $idUsuario?>">
          <input type="hidden" id="plan" name="plan" value="2"> 1 mes por $5.000.-
          <br/>
