...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="content"> 
      ...
      De su opinion sobre la atención recibida.
      <form action="guardarPuntaje.php" method="post">
          <input type="hidden" id="id" name="id" value="<?php echo $id; ?>">
          Puntaje (Escala de 1 a 5): <input type="number" min="1.0" max="5.0" id="puntaje" name="puntaje" required=""><br>
          Comentario: <textarea name="comentario" id="comentario" required></textarea><br>
