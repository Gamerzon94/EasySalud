...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="content"> 
      ...
      Se ha registrado su solicitud, se le enviara una confirmacion por Email junto con los pasos que seguiran para la eliminación del perfil.<br/>
      <center><button onclick="location.href='cerrarSesion.php'">Aceptar</button></center>
      <?php }else{?>
