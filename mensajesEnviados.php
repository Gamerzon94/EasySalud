<?php
	...
	$rol = $_COOKIE["rol"];
        ...
        $auxMensajes = obtenerMensajesEnviados($idUsuario);
	}
	$admin = "1";
	$usuario1 = "2";
        $profesional = "3";
  ...
  <main class="hoc container clear"> 
    ...
    <div class="content"> 
      <!-- ################################################################################################ -->
        <?php if(isset($_COOKIE["rol"])){ ?>
      <h1>Mensajes</h1>
      <input type="button" value="Mensajes recibidos" name="enviados" onclick="window.location.href = 'mensajes.php'"/>
      <table>
          <tr>
              <td>
                  Asunto
          ...
          <?php $count = 0;
          while($mensajes = mysqli_fetch_array($auxMensajes)){ ?>
          <tr>
              <td>
                  <a href="mensajes2.php?id=<?php echo $mensajes["C_ID_MENSAJE"]; ?>"><?php echo $mensajes["D_TITULO_MENSAJE"]?></a>
              </td>
              <td>
                  <?php $auxDe = obtenerDatosPersonas($mensajes["C_ID_USUARIO_RECIBE"]);
              ...
              <td>
                  <?php echo $mensajes["F_FECHA_REGISTRO"];
                  $count++; ?>
              </td>
          </tr>
          <?php }
          if($count == 0){
              ?><tr>
                  <td colspan="3">
              <center>No tiene mensajes en este momento.</center>
                  </td>
</tr><?php
          }?>
      </table>
