      ...
      <center>
        <form action="sesion.php" method="post">
            <table>
                ...
                <tr><td width=400><label for="pass">Contraseña <span>*</span></label></td>
                    <td><input type="password" name="cla" id="cla" value="" size="50" required> </td></tr>
                <tr><td width=400 align=right><input type="submit" name="submit" value="Iniciar Sesión"></td><td>
                        <input type="reset" name="reset" value="Limpiar"></td></tr></table>
        </form>
          <span>* Obligatorios</span><br/>
          <a href="recuperarContrasena.php">¿Has olvidado tu contraseña?</a>&nbsp;<a href="activarCuenta.php">¿Cuenta Inactiva? Haz Click aquí</a>
      </center>
      </div>
      <!-- ################################################################################################ -->
    </div>
