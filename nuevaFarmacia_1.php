<?php
	...
	$usuario = "2";
        ...
        if(isset($_POST["guardar"])){
            $nombre = $_POST["nombre"];
            $web = $_POST["web"];
            nuevaFarmacia($nombre,$web,$idUsu);
            ?><script>alert("Farmacia creada con exito");</script><?php
       ...
       <?php if(isset($_COOKIE["rol"])){
        ...
        <center>
            <table>
                ...
                <tr>
                    <td colspan="2">
                <center><input type="submit" name="guardar" id="guardar" value="Crear Farmacia"></center>
                    </td>
                </tr>
            </table>
        </center>
