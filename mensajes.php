  ...
  <main class="hoc container clear"> 
    ...
    <div class="content"> 
      <!-- ################################################################################################ -->
        <?php if(isset($_COOKIE["rol"])){ ?>
      <h1>Mensajes</h1>
      <input type="button" value="Mensajes enviados" name="enviados" onclick="window.location.href = 'mensajesEnviados.php'"/>
      <table>
          <tr>
              <td>
                  Asunto
          ...
          <tr>
              ...
              <td>
                  <?php $auxDe = obtenerDatosPersonas($mensajes["C_ID_USUARIO_ENVIA"]);
