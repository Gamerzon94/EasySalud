<?php
	...
	$usuario1 = "2";
        ...
        if(isset($_GET["id"])){
            ...
            $auxPara = obtenerDatosPersonas($id);
        }
?>
<!DOCTYPE html>
<!--
    ...
    <div class="content"> 
      ...
      <table>
          <tr>
              ...
              <td>
                  <input type="hidden" value="<?php echo $id; ?>" name="para" id="para" required>
                  <input type="hidden" value="<?php echo $idUsuario; ?>" name="de" id="de" required>
                  <?php while($para = mysqli_fetch_array($auxPara)){
          ...
          <tr>
              ...
              <td>
                  <?php if($titu == TRUE){ ?>
                  <input type="text" value="RE: <?php echo $titulo; ?>" name="titulo" id="titulo" required>
                  <?php }else{ ?>
          ...
          <tr>
              ...
              <td>
                  <textarea name="mensaje" id="mensaje" required cols="80" rows="5"></textarea>
              </td>
          </tr>
          <tr>
              <td colspan="2">
