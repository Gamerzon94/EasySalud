<?php
	...
	$usuario = "2";
        ...
        if(isset($_GET["id"])){
            $idFarmacia = $_GET["id"];
            $auxFarmacia = buscarFarmaciaEspecifica($idFarmacia);
        }else{
        ...
        if(isset($_POST["guardar"])){
            $nombre = $_POST["nombre"];
            $web = $_POST["web"];
            modificarFarmacia2($idFarmacia,$nombre,$web);
            ?><script>alert("Farmacia modificada con exito");</script><?php
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="content">
       <?php if(isset($_COOKIE["rol"])){
           if($rol == $farmacia){
           while($datosFarmacia = mysqli_fetch_array($auxFarmacia)){ ?>
        <h1>Modificar farmacia <?php echo $datosFarmacia["D_NOMBRE_FARMACIA"]; ?></h1>
        ...
        <center>
            <table>
                <tr>
                    ...
                    <td>
                        <input type="text" name="nombre" id="nombre" value=" <?php echo $datosFarmacia["D_NOMBRE_FARMACIA"]; ?>" required>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <input type="text" name="web" id="web" value=" <?php echo $datosFarmacia["D_WEB_FARMACIA"]; ?>" required>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                <center><input type="submit" name="guardar" id="guardar" value="Modificar Farmacia"></center>
                    </td>
                </tr>
            </table>
        </center>
