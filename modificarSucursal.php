<?php
	...
	$usuario = "2";
        ...
        if(isset($_GET["id"])){
            $idSucursal = $_GET["id"];
            $datosSucursal = buscarSucursalEspecifica($idSucursal);
        }else{
        ...
        if(isset($_POST["guardar"])){
            ...
            $comuna = $_POST["comuna"];
            $tel = $_POST["telefono"];
            modificarSucursal($idSucursal,$nombre,$tel,$dir,$comuna);
            ...
            ?><script>alert("Sucursal modificada con exito");</script><?php
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="content">
       <?php if(isset($_COOKIE["rol"])){
           if($rol == $farmacia){
               while($auxSucursal = mysqli_fetch_array($datosSucursal)){?>
        <h1>Modificar Sucursal <?php echo $auxSucursal["D_NOMBRE_SUCURSAL"]; ?></h1>
        ...
        <center>
            <table>
                <tr>
                    ...
                    <td>
                        <input type="text" name="nombre" id="nombre" value="<?php echo $auxSucursal["D_NOMBRE_SUCURSAL"]; ?>" required>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <input type="text" name="dir" id="dir" value="<?php echo $auxSucursal["D_DIRECCION_SUCURSAL"]; ?>" required>
                    </td>
                </tr>
                <tr>
                    <td>
			...
			<?php while($auxRegion = mysqli_fetch_array($link)){
                            if($auxRegion['C_ID_REGION'] == $auxSucursal['C_ID_REGION']){?>
			...
			<option value="0">Seleccione comuna</option>
                ...
                <tr>
                    ...
                    <td>
                        <input type="number" id="telefono" name="telefono" min="111111111" max="999999999" value="<?php echo $auxSucursal["N_TELEFONO_SUCURSAL"]; ?>" required>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                <center><input type="submit" name="guardar" id="guardar" value="Modificar Sucursal"></center>
                    </td>
                </tr>
            </table>
        </center>
