<?php
	...
	$usuario = "2";
        ...
        while($auxAux = mysqli_fetch_array($auxId)){
            $idProfesional = $auxAux['C_ID_PROFESIONAL'];
            break;
        }
          ...
          <center>
              <table>
                  ...
                  <tr>
                      ...
                      <td WIDTH="20%">
                          <a href="eliminarEstudio.php?id=<?php echo $fila['C_ID_ESTUDIOS_PROFESIONAL'] ?>"><img src="images/delete.png" style="max-width:15%;width:auto;height:auto;" title="Eliminar" alt="Eliminar"></a>
                      </td>
                  </tr>
                  <?php } ?>
              </table>
